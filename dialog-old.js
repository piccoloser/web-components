...
function btnCloseStyle(darkTheme, rgba) {
    const color = Color.fromRGBA(rgba || "rgba(255, 255, 255, 1)");

    rgba ? console.log(color.rgba) : darkTheme ? "#fff" : "#000";
    ...
    return `
        #btn-close {
            ...
            --bg: ${rgba ? color.rgba : darkTheme ? "#fff" : "#000"};
        }
        #btn-close:hover {
            --bg: ${darkTheme ? "#ddd" : "#222"};
        }
...
class ModalDialog extends HTMLElement {
    constructor() {
        ...
        this.bgColor = Color.fromComputedStyle(this, "rgba(200, 200, 200, 1)");
        this.color = Color.fromComputedStyle(this, "#000", "color");
        ...
        const style = addElement("style", {
            textContent: `
                * {
                ...
                ${btnCloseStyle(this.hasAttribute("dark", this.color.rgba))}
                ...
                #dialog-title {
                    ...
                    padding: .5rem 4rem;
                    text-align: center;
                    background-color: ${this.bgColor.brightness(-20).rgba};
                }
    ...
    display(message, timeout = 10) {
        ...
        content.appendChild(addElement("div", {
            style: `
                ...
                height: 4px;
                width: 100%;
                background: ${this.bgColor.brightness(this.hasAttribute("dark") ? 50 : -50).rgba}; 
